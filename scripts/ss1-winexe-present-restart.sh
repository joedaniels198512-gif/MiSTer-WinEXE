...
#      SS1_DIRTY, SS1_TILE_W, SS1_TILE_H, SS1_DIRTY_PCT, SS1_FRAME_US, SS1_XSYNC, SS1_OSYNC
set -e
...
mkdir -p "$LOGDIR"
echo "===== restart hz=$SS1_HZ skip=$SS1_SKIP_UNCHANGED dirty=$SS1_DIRTY tile=${SS1_TILE_W}x${SS1_TILE_H} pct=$SS1_DIRTY_PCT $(date) =====" >>"$PRESLOG"
...
echo "presenter_ok pid=$(cat /tmp/ss1-winexe-x11-present.pid) hz=$SS1_HZ skip=$SS1_SKIP_UNCHANGED dirty=$SS1_DIRTY tile=${SS1_TILE_W}x${SS1_TILE_H}"
